...
$conn = new mysqli($servername, $username, $password, $dbname);
	...
	$temp=0;
		...
		if(isset($_GET["cat"]))
		{
			...
			$result1 = mysqli_query($conn,"SELECT * FROM books WHERE subcat='$cat' AND status='Open for sale' ORDER BY no"); 
		...
		else
		{
			...
			$result1 = mysqli_query($conn,"SELECT * FROM books WHERE status='Open for sale' ORDER BY no"); 
						...
						echo '<table width="100%">
								<tr>
									<td valign="center" width="5%">
										<img src="foto/'.$row["image"].'" height="58" width="58">
									<td width="40%">
									...
									'<td width="10%" bgcolor="">
										...
										<form method="get" action="book.php">
											<button class="btn btn-5 btn-5b icon-cart-2" name="id" value="'.$t.'">
									...
									<td width="10%" bgcolor="">
										<form action="" method="post"> 
											...
											<input type="hidden" name="bid" value="'.$t.'" >
										</form>
